...
use maos_core::config::{MaosConfig, ConfigLoader};
...
fn test_config_with_env_overrides() {
    ...
    env_vars.insert("MAOS_SYSTEM_MAX_EXECUTION_TIME_MS".to_string(), "5000".to_string());
    env_vars.insert("MAOS_SYSTEM_WORKSPACE_ROOT".to_string(), "/custom/path".to_string());
    env_vars.insert("MAOS_SECURITY_ENABLE_VALIDATION".to_string(), "false".to_string());
...
fn test_config_serialization() {
    ...
    assert_eq!(cfg.system.max_execution_time_ms, cfg2.system.max_execution_time_ms);
}
